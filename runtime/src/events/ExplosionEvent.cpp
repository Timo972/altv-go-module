...
{
    static auto call = GET_FUNC(Library, "altExplosionEvent", bool (*)(alt::IPlayer* source, alt::IEntity* target, Position position, short explosionType, unsigned int explosionFX));
